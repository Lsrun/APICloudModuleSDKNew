...
public class BuyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isDing =  Config.getIsDing(this,uid,aid);
        if(isDing){
            ...
            switch (msg.what) {
                ...
                case 456:
                    try {
                        ...
                        if (code == 1 || string.contains("已经购买")) {
                            if((code == 0 && string.contains("已经购买")) || "unsetautobuy".equals(ReadActivity.act) ){
                                code = 2;
                            }
